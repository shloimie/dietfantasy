...
export default function SignPage() {
    ...
    const [user, setUser] = useState<{ id: number; first: string; last: string } | null>(null);
    ...
    const statements = useMemo(
        () => [
            "I hereby authorize Diet Fantasy to apply my electronic signature to future attestations confirming that I have personally received my medically tailored meals.",
            ...
            "I understand that this authorization will remain in effect until I revoke it in writing and that I may withdraw my consent at any time by contacting Diet Fantasy.",
        ],
        []
    );
    ...
    return (
        ...
        >
            ...
            <p style={{ marginBottom: 16, color: "#444" }}>
                By signing the following sections, I give Diet Fantasy permission to securely store and
